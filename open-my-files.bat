...
start Notepad++ js/utility/constants.js
start Notepad++ js/model/point.js
REM start Notepad++ js/views/text-view.js
REM start Notepad++ js/views/graph-view.js
start Notepad++ js/controllers/settings-controller.js
REM start Notepad++ js/controllers/emphasis-controller.js
REM start Notepad++ js/tests/sample-graphs.js
